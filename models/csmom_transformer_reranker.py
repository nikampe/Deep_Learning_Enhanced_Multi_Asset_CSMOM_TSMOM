...
class CSMOMPreranker(tf.keras.Model):
    def __init__(self, width_1, width_2, activation, dropout_rate):
        super(CSMOMPreranker, self).__init__()
...
class CSMOMTransformerReranker(tf.keras.Model):
    def __init__(self, num_categories, num_layers, d_model, num_heads, dff, dropout_rate=0.1):
        super(CSMOMTransformerReranker, self).__init__()
